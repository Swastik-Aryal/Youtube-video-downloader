...
def download_mp4(video):
    ...
    dow_ins = Label(root, text="The file has been downloaded in the Downloads folder. ", font=("Helvetica", 12), fg="red")
    dow_ins.grid(row=10, column=0, padx=5, pady=7)
    # dow_ins = Label(root, text="file location where this app is present",
